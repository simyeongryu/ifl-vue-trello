<template>
  <div class="board-menu">
    ...
    <ul class="menu-list">
      ...
      <div class="color-picker" @click.prevent="onChangeTheme">
        <a href data-value="rgb(0, 121, 191)"></a>
        <a href data-value="rgb(210, 144, 52)"></a>
        <a href data-value="rgb(81, 152, 57)"></a>
        <a href data-value="rgb(176, 70, 50)"></a>
      </div>
    </ul>
  </div>
</template>
